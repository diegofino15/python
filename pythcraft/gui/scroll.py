...
class Scroll:
    ...
    def get_val(self) -> float: return self.variable
    def get_original_val(self) -> float: return self.original_variable

    def set(self, new_val) -> None:
